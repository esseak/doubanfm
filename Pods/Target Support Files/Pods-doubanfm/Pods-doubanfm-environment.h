...
#define COCOAPODS_POD_AVAILABLE_GoogleAnalyticsSDKForOSX
#define COCOAPODS_VERSION_MAJOR_GoogleAnalyticsSDKForOSX 1
#define COCOAPODS_VERSION_MINOR_GoogleAnalyticsSDKForOSX 0
#define COCOAPODS_VERSION_PATCH_GoogleAnalyticsSDKForOSX 0
